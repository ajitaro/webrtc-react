  ...
  try {
    ...
    pc.onicecandidate = e => {
      ...
      if (e.candidate) {
        ...
        message.sdpLineIndex = e.candidate.sdpMLineIndex
      }
    ...
    <>
      <main className='container'>
        ...
        <div className='btn'>
          ...
          <button className='btn-item btn-end' ref={hangupButton} onClick={hangB}>End</button>
          <button className='btn-item btn-start' ref={muteAudButton} onClick={muteAudio}>{audio ? 'Unmute' : 'Mute'}</button>
        </div>
      </main>
    </>
  )
